...
public class Sound implements TextToSpeech.OnInitListener {
    final static String TAG = Sound.class.getSimpleName();
    ...
    /**
     * Callbacks are registered for upon initialization. Set an activity on the Sound
     ...
     * activity if you want the Sound's state to be tied to the activity lifecycle
     */
    ...
    public Sound(final Application application) {
        ...
        this.callbacks = new Application.ActivityLifecycleCallbacks() {
            ...
            public void onActivityDestroyed(Activity activity) {
                if (Sound.this.activity == activity) {
                    shutdown();
                }
            }
        };
